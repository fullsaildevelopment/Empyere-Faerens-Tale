...
public class ItemCreation : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        turboether.Type = ItemType.Mana;
        turboether.Points = 1.00f;
        turboether.price = 75;
        items.Add(turboether);

        Item Elixir = new Item();
        Elixir.Name = "Elixir";
        Elixir.Type = ItemType.Full;
        Elixir.Points = 1.00f;
        Elixir.price = 150;
        items.Add(Elixir);
        ...
        TurboElixir.Type = ItemType.FullParty;
        ...
        Item bomb = new Item();
        bomb.Name = "Bomb";
        bomb.Type = ItemType.DamageParty;
        bomb.Points = .15f;
        bomb.price = 20;
        items.Add(bomb);
        #endregion
